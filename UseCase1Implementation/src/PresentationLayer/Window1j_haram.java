...
public class Window1j_haram extends JFrame {
	...
	public static void showWindow(final UrduString_haram txt) {
	...
	public Window1j_haram(final UrduString_haram urdutext) {
		...
		list.addListSelectionListener(new ListSelectionListener() {
		      public void valueChanged(ListSelectionEvent evt) {
		        ...
		        Old=Word;
		        NewWord=UrduString_haram.Check(Word);
		...
		final JList list_1 = new JList(listModel2);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(Word!=null) {
				UrduString_haram.SetTextField(textField,Old,Word);
				}
				listModel.clear();
				try {
		...
		backBtn.setBounds(10, 443, 89, 23);
